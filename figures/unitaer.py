...
c.text(0, 0, r'U$_\text{f}$', [text.halign.center, text.valign.middle])
...
c.text(xoff, 0, 'f', [text.halign.center, text.valign.middle])
...
c.stroke(path.line(xoff+2.53, yoff+0.7, xoff+2.5+0.24, yoff+0.7+0.18), [deco.earrow.small])
c.stroke(path.path(path.arc(xoff+2.5, yoff+0.7, 0.3, -55, 55)))
c.text(xoff+2.9, yoff+0.8, '|0⟩ → konstant')
c.text(xoff+2.9, yoff+0.6, '|1⟩ → ausgeglichen', [text.valign.top])
c.text(xoff+1.8, yoff+0.7, 'H', [text.halign.center, text.valign.middle])
c.text(xoff, yoff, r'U$_\text{f}$', [text.halign.center, text.valign.middle])
c.text(xoff-3.5, yoff+0.9, 'c')
